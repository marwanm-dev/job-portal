...
export default function FeaturesSection() {
  return (
    <section className="py-20 px-6 text-center bg-white font-semibold">
      <h2 className="text-4xl font-bold text-b9.5 mb-4">
        Why You'll Love this website
      </h2>
      <p className="mb-12 mx-auto max-w-2xl leading-5 font-normal text-base text-b8">
          ...
          icon={
            ...
            >
              <path
                ...
                fill="#074A80"
              />
              <g clip-path="url(#clip0_2778_2672)">
                <path
